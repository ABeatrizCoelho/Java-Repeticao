...
public class Exer69versao2 {
    ...
    public static void main(String[] args) {
        ...
        voto = e.nextInt();
        while (voto != 0) {
            if (voto >= 1 && voto <= 6) { // Verifica se o voto é válido (de 1 a 6)
                switch (voto) {
                    case 1:
                        candidato1++;
                        break;
                ...
                System.out.println("Voto inválido. Por favor, digite um número válido de 1 a 6.");
            }
